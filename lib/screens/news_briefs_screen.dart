...
class NewsBriefsScreen extends StatefulWidget {
  static const screenRoute = '/news-briefs';
  const NewsBriefsScreen({Key? key}) : super(key: key);

  @override
  State<NewsBriefsScreen> createState() => _NewsBriefsScreenState();
}

class _NewsBriefsScreenState extends State<NewsBriefsScreen> {
// We will fetch data from this Rest api
// final _baseUrl = 'https://jsonplaceholder.typicode.com/posts';
  final _baseUrl = 'https://ognreports.news/wp-json/wp/v2/posts?categories=205';
