...
class BKShowScreen extends StatefulWidget {
  static const screenRoute = '/bk-show';
  const BKShowScreen({Key? key}) : super(key: key);

  @override
  State<BKShowScreen> createState() => _BKShowScreenState();
}

class _BKShowScreenState extends State<BKShowScreen> {
// We will fetch data from this Rest api
// final _baseUrl = 'https://jsonplaceholder.typicode.com/posts';
  final _baseUrl = 'https://ognreports.news/wp-json/wp/v2/posts?categories=208';
...
// The controller for the ListView
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: AppDrawer(),
      appBar: MyAppBar('Weekly Q & A with Bilal Abdul Kareem'),
