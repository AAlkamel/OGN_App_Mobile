...
class JusticeSeriesScreen extends StatefulWidget {
  ...
  @override
  State<JusticeSeriesScreen> createState() => _JusticeSeriesScreenState();
}

class _JusticeSeriesScreenState extends State<JusticeSeriesScreen> {
// We will fetch data from this Rest api
// final _baseUrl = 'https://jsonplaceholder.typicode.com/posts';
  final _baseUrl = 'https://ognreports.news/wp-json/wp/v2/posts?categories=207';
