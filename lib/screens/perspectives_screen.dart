...
class PerspectivesScreen extends StatefulWidget {
  static const screenRoute = '/perspectives';
  const PerspectivesScreen({Key? key}) : super(key: key);
...
// final _baseUrl = 'https://jsonplaceholder.typicode.com/posts';
  final _baseUrl = 'https://ognreports.news/wp-json/wp/v2/posts?categories=206';
