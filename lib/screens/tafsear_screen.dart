...
class TafsearScreen extends StatefulWidget {
  ...
  @override
  State<TafsearScreen> createState() => _TafsearScreenState();
}

class _TafsearScreenState extends State<TafsearScreen> {
// We will fetch data from this Rest api
// final _baseUrl = 'https://jsonplaceholder.typicode.com/posts';
  final _baseUrl = 'https://ognreports.news/wp-json/wp/v2/posts?categories=201';
