...
class TheSourceScreen extends StatefulWidget {
  static const screenRoute = '/the-source';
  const TheSourceScreen({Key? key}) : super(key: key);

  @override
  State<TheSourceScreen> createState() => _TheSourceScreenState();
}

class _TheSourceScreenState extends State<TheSourceScreen> {
// We will fetch data from this Rest api
// final _baseUrl = 'https://jsonplaceholder.typicode.com/posts';
  final _baseUrl = 'https://ognreports.news/wp-json/wp/v2/posts?categories=202';
